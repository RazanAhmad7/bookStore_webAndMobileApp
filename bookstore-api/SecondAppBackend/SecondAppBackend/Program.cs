...
// Step 7.3b: Register File Upload Service
...
// Step 7.6: Configure CORS for Flutter app communication and React Admin
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowFlutterApp",
        policy => policy
            ...
            .AllowAnyMethod()
            .AllowAnyHeader()
            .WithExposedHeaders("Content-Range")); // Expose Content-Range for React Admin
});
...
// Step 7.7b.1: Configure static files for uploaded images
app.UseStaticFiles();
