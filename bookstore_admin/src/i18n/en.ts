...
const customEnglishMessages: TranslationMessages = {
    ...
    resources: {
        ...
        books: {
            ...
            notifications: {
                created: 'Book created |||| %{smart_count} books created',
                updated: 'Book updated |||| %{smart_count} books updated',
                deleted: 'Book deleted |||| %{smart_count} books deleted',
            },
        },
        categories: {
        ...
        authors: {
            ...
            notifications: {
                created:
                    'Author created |||| %{smart_count} authors created',
                updated:
                    'Author updated |||| %{smart_count} authors updated',
                deleted:
                    'Author deleted |||| %{smart_count} authors deleted',
            },
        },
        reviews: {
            name: 'Review |||| Reviews',
